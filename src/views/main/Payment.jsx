...
class Payment extends Component {
	...
	constructor(props){
		...
		this.alterFavoriteCard = this.alterFavoriteCard.bind(this);
		this.alterFavoriteAdderss = this.alterFavoriteAdderss.bind(this);
		this.openCartaoModal = this.openCartaoModal.bind(this);
		this.closeCartaoModal = this.closeCartaoModal.bind(this);
		this.openAddressModal = this.openAddressModal.bind(this);
		this.closeAddressModal = this.closeAddressModal.bind(this);
		this.findPromotionalCoupon = this.findPromotionalCoupon.bind(this);
		this.findChangeCoupon = this.findChangeCoupon.bind(this);
